...
public class DairyAdapter extends ArrayAdapter {
    ...
    public DairyAdapter( Context context,ArrayList<WorkCommentItem> works,String pid) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (v == null) {
            ...
            v.setTag(R.id.txt_project, v.findViewById(R.id.txt_project));
        ...
        txt_project = (TextView) v.getTag(R.id.txt_project);
